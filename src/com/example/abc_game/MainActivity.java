...
import com.example.draw.GameBoard;
...
public class MainActivity extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      mp = MediaPlayer.create(MainActivity.this, R.raw.bkg);
     // mp.start();
        ...
        synchronized public void run() {
              if (((GameBoard)findViewById(R.id.the_canvas)).wasCollisionDetected()) {
                  ...
                  // mp1.stop();
                   ...
                   builder2.setMessage("Sorry you Lost the Game!!!! ");
                   builder2.setPositiveButton("PLay Again",new DialogInterface.OnClickListener() {
...
((GameBoard)findViewById(R.id.the_canvas)).getLastCollision();
          ...
          //   ((TextView)findViewById(R.id.the_label)).setText("Sprite Acceleration("+Integer.toString(sprite2Velocity.x)+","+Integer.toString(sprite2Velocity.y)+")");
             Point sprite1 = new Point(((GameBoard)findViewById(R.id.the_canvas)).getSprite1X(),((GameBoard)findViewById(R.id.the_canvas)).getSprite1Y()) ;
             Point sprite2 = new Point(((GameBoard)findViewById(R.id.the_canvas)).getSprite2X(),((GameBoard)findViewById(R.id.the_canvas)).getSprite2Y());
